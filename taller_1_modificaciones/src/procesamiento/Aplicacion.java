...
public static void main(String[] args) throws IOException{
	...
	List<bebidas>lasbebidas= new ArrayList<>();
	...
	lasbebidas = Restaperros.cargarBebidas();
	boolean ciclo=true;
	while (ciclo==true){
    ...
    if (userName.equals("5")){
    	...
    	{
    		System.out.println("nombre de la bebida: "+lasbebidas.get(i).getNombre());
    		System.out.println("precio de la bebida: "+lasbebidas.get(i).getPrecio());
    	}
    ...
    else if (userName.equals("2"))
    {
	    ...
	    ListaDePedidos = Restaperros.iniciarPedido(nombreUsuario, direccion, ProductosDelMenu, ingredientes, ListaDeCombos, lasbebidas);
    ...
    else if (userName.equals("3"))
    {
	    ...
	    if(opciones==ListaDePedidos.get(0).getIdPedidos()) 
	    {
	    	...
	    	for( int k=0;k<ListaDePedidos.get(0).getBebidasAd().size();k++) 
	    	{ 
	    		   
	    		System.out.println(ListaDePedidos.get(0).getBebidasAd().get(k).getNombre());
    ...
    else if (userName.equals("4")) 
    {
    	...
    	int ValorBebida = ValorTotal + Restaperros.combosPrecioBebidas(ListaDeCombos, ListaDePedidos.get(0).getCombos(), lasbebidas);
	    ...
	    String nombreUsuario1 = myObj11.nextLine();
	    int opciones1=Integer.parseInt(nombreUsuario1);	
	    
	    if (opciones1 >= ValorTotal) 
	    {
	    	...
	    	myWriter.write("\n");
	    	myWriter.write("su cambio es: "+(opciones1-ValorTotal));
	    	myWriter.write("\n");
	    	...
	    	myWriter.write("\n");
	    	myWriter.write("calorias: "+ListaDePedidos.get(0).getProductosPedidosId().get(i).getCalorias());
	      	myWriter.write("\n");
	    	}
	    	...
	    	myWriter.write("\n");
	    	myWriter.write("calorias: "+ListaDePedidos.get(0).getIngredienteAd().get(i).getCalorias());
	    	myWriter.write("\n");
	    	}
	    	...
	    	myWriter.write("\n");
	    	myWriter.write("calorias: "+ListaDePedidos.get(0).getCombos().get(i).getCalorias());
	    	myWriter.write("\n");
	    	}
	    	
	    	for (int i=0;i<ListaDePedidos.get(0).getBebidasAd().size();i++)
	    	{
	    	myWriter.write("Producto: "+ListaDePedidos.get(0).getBebidasAd().get(i).getNombre());
	    	myWriter.write("\n");
	    	myWriter.write("calorias: "+ListaDePedidos.get(0).getBebidasAd().get(i).getCalorias());
	    	myWriter.write("\n");
	    	}
	    	myWriter.close();
	    }
	    ...
	    {
	    	System.out.println("pago insuficiente le faltan: "+ (ValorTotal-opciones1)+"$");
	    }
    }
