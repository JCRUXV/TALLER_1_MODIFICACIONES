...
public class pedido
{
	 ...
	 public pedido(List<ProductoMenu> productosPedidosId, List<combo> combos, List<ingrediente> ingredienteAd,
			List<bebidas> bebidasAd, String nombreCliente, String direccionCliente, 
			int idPedidos) {
		super();
		this.productosPedidosId = productosPedidosId;
		this.combos = combos;
		this.ingredienteAd = ingredienteAd;
		this.bebidasAd = bebidasAd;
		this.nombreCliente = nombreCliente;
		this.direccionCliente = direccionCliente;
		this.idPedidos = idPedidos;
	}

	List <bebidas> bebidasAd;
	 
	 
	 
	
	 public List<bebidas> getBebidasAd() {
		return bebidasAd;
	}



	public void setBebidasAd(List<bebidas> bebidasAd) {
		this.bebidasAd = bebidasAd;
	}
